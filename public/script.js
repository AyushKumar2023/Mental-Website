...
// Doctor
  ...
  // document.getElementById("doctorChatTrigger").addEventListener("click", function () {
  //   const chatSection = document.getElementById("Chat");

  //   // Scroll smoothly to the chat section
  //   chatSection.scrollIntoView({ behavior: "smooth" });

  //   // Optional: highlight or flash chat section (feel free to remove this)
  //   chatSection.style.boxShadow = "0 0 20px rgba(0, 128, 255, 0.6)";
  //   setTimeout(() => {
  //     chatSection.style.boxShadow = "none";
  //   }, 2000);
  // // });
  // document.getElementById("doctorChatTrigger").addEventListener("click", function () {
  //   const chatSection = document.getElementById("Chat");
